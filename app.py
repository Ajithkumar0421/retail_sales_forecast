...
if option == 'Home':
     ...
     st.write("LinkedIn : https://www.linkedin.com/in/ajith-kumar-b9578b14a/")
     st.write("Gmail_Id : ajithkumar0421@gmail.com")
...
if option == "Markdown Prediction":
     ...
     with col1:
          ...
          Type = st.selectbox("select any one type", (0., 1., 2.))
     ...
     with col2:
        ...
        Year       = st.selectbox('Select any one Year',(2010,2011,2012))
        
     if st.button('Predict'):
        Markdown_pred = _model.predict([[Store,Type,Size,Temperature,Fuel_Price,MarkDown3,MarkDown4,MarkDown5,CPI,Unemployment,IsHoliday,Dept,Weekly_Sales,Day,Month,Year]])
...
if option == 'IsHoliday Prediction':
    ...
    with col2:
        ...
        (2010,2011,2012))
    if st.button('Predict'):
        holiday_pred = _model.predict([[Store,Type,Size,Temperature,Fuel_Price,MarkDown1,MarkDown2,MarkDown3,MarkDown4,MarkDown5,CPI,Unemployment,Dept,Weekly_Sales,Day,Month,Year]])
...
if option == 'Unemployment Prediction':
    ...
    if st.button('Predict'):
        unemp_pred = _model.predict([[Store,Type,Size,Temperature,Fuel_Price,MarkDown1,MarkDown2,MarkDown3,MarkDown4,MarkDown5,CPI,IsHoliday,Dept,Weekly_Sales,Day,Month,Year]])
...
if option == 'Type Prediction':
    ...
    with col2:
        ...
        (2010,2011,2012))
    if st.button('Predict'):
        type_pred = _model.predict([[Store,Size,Temperature,Fuel_Price,MarkDown1,MarkDown2,MarkDown3,MarkDown4,MarkDown5,CPI,Unemployment,IsHoliday,Dept,Weekly_Sales,Day,Month,Year]])
